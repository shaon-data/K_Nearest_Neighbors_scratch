...
So it is relatively fast for its implementation as it needs not any parametric thinking to set up importantce for features.
And it directly tests the new samples so it doesn't need any training time.
